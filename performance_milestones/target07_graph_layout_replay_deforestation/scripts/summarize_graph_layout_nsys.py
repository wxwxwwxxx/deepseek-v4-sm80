...
def classify_kernel(name: str) -> str:
    lowered = name.lower()
    if "_fp8_activation_quantize_kernel" in lowered:
        return "fp8_activation_quant_poc"
    if "nccl" in lowered:
...
def main() -> None:
    ...
    summary["classifier"] = "target07_54_graph_layout_replay_deforestation"

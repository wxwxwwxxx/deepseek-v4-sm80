...
MILESTONE_DIR="${ROOT}/performance_milestones/target08_route_b_final_prefix_promotion_gate_rerun"
...
python "${MILESTONE_DIR}/scripts/summarize_final_gate_rerun.py" \
  --milestone-dir "${MILESTONE_DIR}"

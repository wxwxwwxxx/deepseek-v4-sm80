...
MILESTONE_DIR="${MILESTONE_DIR:-${MINISGL_ROOT}/performance_milestones/target07_direct_copy_owner_attribution}"
...
RUN_TAG="${RUN_TAG:-target0765_${VARIANT}_${PROMPT_LEN}x${DECODE_LEN}_bs${BATCH_SIZE}_np${NUM_PAGES}}"

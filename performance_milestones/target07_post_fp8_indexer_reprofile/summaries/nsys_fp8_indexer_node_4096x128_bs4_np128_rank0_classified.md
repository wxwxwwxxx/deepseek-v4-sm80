...
| --- | ---: | ---: | ---: | ---: | ---: |
| `graph_runtime_copy_cat_index` | 668939 | `3.199357` | 26.91% | 458724 | 3612 |
| `elementwise_graph_nodes` | 579196 | `1.862044` | 15.66% | 556768 | 4384 |
| `fp8_indexer` | 21379 | `0.256262` | 2.16% | 20828 | 164 |
| `sparse_attention_decode` | 22100 | `0.121039` | 1.02% | 21590 | 170 |
| `prefill_sparse_attention` | 43 | `2.129782` | 17.92% | 0 | 0 |
| `kv_compressor_cache_store` | 8362 | `0.068663` | 0.58% | 8128 | 64 |
| `projection_gemm` | 103590 | `2.218327` | 18.66% | 100965 | 795 |
| `moe_marlin` | 67080 | `0.835499` | 7.03% | 43688 | 344 |
| `nccl_communication` | 11528 | `0.507735` | 4.27% | 11176 | 88 |
| `sampling_logits` | 45131 | `0.637334` | 5.36% | 43815 | 345 |
| `unknown` | 11746 | `0.050861` | 0.43% | 11049 | 87 |
...
| `void at::native::vectorized_elementwise_kernel<(int)4, at::native::float8_copy_kernel_cuda(at::TensorIteratorBase &)::[lambda(float) (ins...` | 36549 | `0.095173` | 35433 | 279 |
...
| `void at::native::elementwise_kernel<(int)128, (int)4, void at::native::gpu_kernel_impl_nocast<at::native::direct_copy_kernel_cuda(at::Ten...` | 11008 | `0.072764` | 0 | 0 |
| `void at::native::vectorized_elementwise_kernel<(int)4, at::native::log2_kernel_cuda(at::TensorIteratorBase &)::[lambda() (instance 2)]::o...` | 36549 | `0.072370` | 35433 | 279 |
| `void <unnamed>::elementwise_kernel_with_index<int, at::native::arange_cuda_out(const c10::Scalar &, const c10::Scalar &, const c10::Scala...` | 33396 | `0.070277` | 0 | 0 |
| `void at::native::reduce_kernel<(int)128, (int)4, at::native::ReduceOp<c10::BFloat16, at::native::func_wrapper_t<c10::BFloat16, at::native...` | 5764 | `0.061181` | 5588 | 44 |
| `void cublasLt::splitKreduce_kernel<(int)32, (int)16, int, float, __nv_bfloat16, float, __nv_bfloat16, (bool)0, __nv_bfloat16, __nv_bfloat...` | 24683 | `0.060879` | 24384 | 192 |
| `void at::native::sbtopk::gatherTopK<float, unsigned int, (int)2, (bool)0>(at::cuda::detail::TensorInfo<const T1, T2>, T2, T2, bool, T2, T...` | 5200 | `0.060367` | 5080 | 40 |
...
| `cudaStreamIsCapturing_v10000` | 3075 | `0.003541` | 0 | 0 |
| `cudaStreamCreateWithPriority_v5050` | 128 | `0.003161` | 0 | 0 |
| `cudaStreamWaitEvent_v3020` | 1539 | `0.002449` | 0 | 0 |
| `cudaStreamEndCapture_v10000` | 3 | `0.001926` | 0 | 0 |
| `cudaMemsetAsync_v3020` | 219 | `0.001810` | 0 | 0 |
| `cudaStreamDestroy_v5050` | 268 | `0.001510` | 0 | 0 |
| `cuMemAddressReserve` | 194 | `0.001508` | 0 | 0 |
| `cudaEventCreateWithFlags_v3020` | 675 | `0.001049` | 0 | 0 |
| `cudaEventSynchronize_v3020` | 128 | `0.000819` | 0 | 0 |
| `cuMemAddressFree` | 194 | `0.000685` | 0 | 0 |
...
| Category | Count | Duration s | Share | Graph events | Graph nodes |
| --- | ---: | ---: | ---: | ---: | ---: |
| `graph_runtime_copy_cat_index` | 502980 | `2.181877` | 20.80% | 458724 | 3612 |
| `elementwise_graph_nodes` | 566419 | `1.812329` | 17.28% | 556768 | 4384 |
| `fp8_indexer` | 20992 | `0.253232` | 2.41% | 20828 | 164 |
| `sparse_attention_decode` | 21590 | `0.117957` | 1.12% | 21590 | 170 |
| `prefill_sparse_attention` | 43 | `2.129782` | 20.31% | 0 | 0 |
| `kv_compressor_cache_store` | 8212 | `0.067961` | 0.65% | 8128 | 64 |
| `projection_gemm` | 101545 | `2.169954` | 20.69% | 100965 | 795 |
| `moe_marlin` | 44032 | `0.582977` | 5.56% | 43688 | 344 |
| `nccl_communication` | 11264 | `0.489769` | 4.67% | 11176 | 88 |
| `sampling_logits` | 44180 | `0.632683` | 6.03% | 43815 | 345 |
| `unknown` | 11527 | `0.050206` | 0.48% | 11049 | 87 |
...
| `ampere_sgemm_128x64_tn` | 43 | `0.084506` | 0 | 0 |
| `ampere_bf16_s16816gemm_bf16_128x128_ldg8_f2f_stages_32x5_tn` | 150 | `0.077166` | 0 | 0 |
| `void <unnamed>::elementwise_kernel_with_index<int, at::native::arange_cuda_out(const c10::Scalar &, const c10::Scalar &, const c10::Scala...` | 33394 | `0.070272` | 0 | 0 |
| `void at::native::vectorized_elementwise_kernel<(int)4, at::native::log2_kernel_cuda(at::TensorIteratorBase &)::[lambda() (instance 2)]::o...` | 35712 | `0.069920` | 35433 | 279 |
| `void at::native::reduce_kernel<(int)128, (int)4, at::native::ReduceOp<c10::BFloat16, at::native::func_wrapper_t<c10::BFloat16, at::native...` | 5632 | `0.060144` | 5588 | 44 |
...
| `void at::native::sbtopk::gatherTopK<float, unsigned int, (int)2, (bool)0>(at::cuda::detail::TensorInfo<const T1, T2>, T2, T2, bool, T2, T...` | 5120 | `0.059309` | 5080 | 40 |
| `_moe_route_fill_kernel` | 11008 | `0.059143` | 10922 | 86 |
| `_rms_norm_bf16_kernel` | 16640 | `0.058704` | 16510 | 130 |
| `_q_kv_norm_rope_cache_bf16_kernel` | 5504 | `0.058660` | 5461 | 43 |
| `void at::native::elementwise_kernel<(int)128, (int)4, void at::native::gpu_kernel_impl<at::native::direct_copy_kernel_cuda(at::TensorIter...` | 11008 | `0.058462` | 10922 | 86 |
| `void at::native::vectorized_elementwise_kernel<(int)4, at::native::BUnaryFunctor<float, float, float, at::native::binary_internal::MulFun...` | 35712 | `0.055559` | 35433 | 279 |
...
| Category | Count | Duration s | Share | Graph events | Graph nodes |
| --- | ---: | ---: | ---: | ---: | ---: |
| `graph_runtime_copy_cat_index` | 4270 | `0.494639` | 10.96% | 0 | 0 |
| `elementwise_graph_nodes` | 4800 | `0.453281` | 10.05% | 0 | 0 |
| `fp8_indexer` | 164 | `0.123096` | 2.73% | 0 | 0 |
| `prefill_sparse_attention` | 43 | `2.129782` | 47.20% | 0 | 0 |
| `kv_compressor_cache_store` | 84 | `0.039876` | 0.88% | 0 | 0 |
| `projection_gemm` | 580 | `0.372682` | 8.26% | 0 | 0 |
| `moe_marlin` | 344 | `0.263697` | 5.84% | 0 | 0 |
| `nccl_communication` | 88 | `0.158514` | 3.51% | 0 | 0 |
| `sampling_logits` | 365 | `0.450105` | 9.98% | 0 | 0 |
| `unknown` | 209 | `0.026561` | 0.59% | 0 | 0 |
...
| `void at::native::elementwise_kernel<(int)128, (int)4, void at::native::gpu_kernel_impl<at::native::direct_copy_kernel_cuda(at::TensorIter...` | 86 | `0.012645` | 0 | 0 |
| `void at::native::elementwise_kernel<(int)128, (int)4, void at::native::gpu_kernel_impl_nocast<at::native::direct_copy_kernel_cuda(at::Ten...` | 216 | `0.008967` | 0 | 0 |
| `void at::native::<unnamed>::cunn_SpatialSoftMaxForward<float, float, float, int, at::native::<unnamed>::SoftMaxForwardEpilogue>(T3 *, con...` | 62 | `0.008539` | 0 | 0 |
| `void <unnamed>::topk_transform_global_lens_kernel<(unsigned int)512>(<unnamed>::TopKGlobalLensParams<T1>)` | 21 | `0.007395` | 0 | 0 |
| `void at::native::<unnamed>::CatArrayBatchedCopy<at::native::<unnamed>::OpaqueType<(unsigned int)4>, unsigned int, (int)3, (int)64, (int)6...` | 84 | `0.005997` | 0 | 0 |
| `void at::native::elementwise_kernel<(int)128, (int)2, void at::native::gpu_kernel_impl_nocast<at::native::CUDAFunctor_add<float>>(at::Ten...` | 103 | `0.005481` | 0 | 0 |
| `void at::native::vectorized_elementwise_kernel<(int)4, at::native::<unnamed>::silu_kernel(at::TensorIteratorBase &)::[lambda() (instance ...` | 43 | `0.005148` | 0 | 0 |
| `void at::native::elementwise_kernel<(int)128, (int)2, void at::native::gpu_kernel_impl_nocast<at::native::direct_copy_kernel_cuda(at::Ten...` | 473 | `0.003915` | 0 | 0 |
| `_moe_route_count_kernel` | 86 | `0.002725` | 0 | 0 |
...
| Category | Count | Duration s | Share | Graph events | Graph nodes |
| --- | ---: | ---: | ---: | ---: | ---: |
| `graph_runtime_copy_cat_index` | 466128 | `1.616983` | 27.38% | 458724 | 3612 |
| `elementwise_graph_nodes` | 561461 | `1.358253` | 23.00% | 556768 | 4384 |
| `fp8_indexer` | 20828 | `0.130136` | 2.20% | 20828 | 164 |
| `sparse_attention_decode` | 21590 | `0.117957` | 2.00% | 21590 | 170 |
| `kv_compressor_cache_store` | 8128 | `0.028085` | 0.48% | 8128 | 64 |
| `projection_gemm` | 100965 | `1.797272` | 30.43% | 100965 | 795 |
| `moe_marlin` | 43688 | `0.319280` | 5.41% | 43688 | 344 |
| `nccl_communication` | 11176 | `0.331255` | 5.61% | 11176 | 88 |
| `sampling_logits` | 43815 | `0.182578` | 3.09% | 43815 | 345 |
| `unknown` | 11301 | `0.023600` | 0.40% | 11049 | 87 |
...
| `_sparse_splitk_bf16_split_kernel` | 5461 | `0.044336` | 5461 | 43 |
| `void at::native::sbtopk::gatherTopK<float, unsigned int, (int)2, (bool)0>(at::cuda::detail::TensorInfo<const T1, T2>, T2, T2, bool, T2, T...` | 5080 | `0.044217` | 5080 | 40 |
| `_sparse_bf16_gather_with_mask_kernel` | 10668 | `0.039792` | 10668 | 84 |
| `void at::native::vectorized_elementwise_kernel<(int)4, at::native::FillFunctor<int>, std::array<char *, (unsigned long)1>>(int, T2, T3)` | 28439 | `0.038869` | 27305 | 215 |
| `_hc_post_kernel` | 10922 | `0.036963` | 10922 | 86 |
| `void at::native::<unnamed>::CatArrayBatchedCopy<at::native::<unnamed>::OpaqueType<(unsigned int)4>, unsigned int, (int)3, (int)64, (int)6...` | 10668 | `0.034105` | 10668 | 84 |
| `_sparse_splitk_bf16_combine_kernel` | 5461 | `0.033830` | 5461 | 43 |
| `_moe_route_fill_kernel` | 10922 | `0.033726` | 10922 | 86 |
| `void at::native::vectorized_elementwise_kernel<(int)4, at::native::CUDAFunctorOnSelf_add<float>, std::array<char *, (unsigned long)2>>(in...` | 19304 | `0.031842` | 19304 | 152 |
| `void at::native::bitonicSortKVInPlace<(int)2, (int)-1, (int)16, (int)16, float, long, at::native::GTOp<float, (bool)1>, unsigned int>(at:...` | 5080 | `0.030313` | 5080 | 40 |

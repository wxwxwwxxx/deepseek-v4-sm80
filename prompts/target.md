...
| TARGET 07 | `prompts/TARGET_07_dsv4_sm80_vllm_gap_closure.md` | planned | DSV4 sm80 vLLM gap closure 新主路线图。当前 milestone opt-in 为 `dsv4_sm80_a100_victory` / `MINISGL_DSV4_SM80_A100_VICTORY_BUNDLE=1`，包含 Marlin WNA16 MoE、CUDA graph、FP8 indexer cache、split-K sparse decode 和四个 BF16 projection cache；4096/1024/batch4 达到 `116.2553 output tok/s`，已超过旧 serving victory line `114.07`。 |

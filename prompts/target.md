...
| TARGET 07 | `prompts/TARGET_07_dsv4_sm80_vllm_gap_closure.md` | planned | DSV4 sm80 vLLM gap closure 新主路线图。当前 best exact 为 Marlin WNA16 + global topk/lens + bf16 split-K sparse decode，4096/1024/batch4 达到 `68.81 output tok/s`，仍低于旧 serving 胜利线 `114.07 output tok/s`。下一步运行 TARGET 07.40。 |
...
| TARGET 07.40 | `prompts/TARGET_07.40_dsv4_sm80_post_splitk_reprofile.md` | next todo | post-splitK reprofile：重新区分 decode split-K、legacy prefill sparse、indexer/cache、runtime/copy，选择 07.41 exact work 或 07.50 opt-in precision/cache lane。 |
| TARGET 07.41 | `prompts/TARGET_07.41_dsv4_sm80_indexer_cache_runtime_exact.md` | conditional todo | 如果 07.40 选择 exact 路线，则处理 bf16 indexer/cache/runtime/copy/graph-buffer bottleneck。 |
| TARGET 07.50 | `prompts/TARGET_07.50_dsv4_sm80_fp8_cache_indexer_precision.md` | conditional todo | 如果 07.40/07.41 证明剩余差距主要来自 packed cache/indexer precision/layout，则开启 opt-in FP8 KV/indexer cache lane；不得改变 exact 默认路径。 |

...
| TARGET 11 | `prompts/TARGET_11_dsv4_sm80_mtp_speculative_decoding.md` | active MTP route | MTP weights/oracle, V1 sidecar, frozen-KV rollback, row0/`wo_a`, and 11.299 row/depth contract work narrowed the blocker to `bs=4` accepted-commit state drift; next is TARGET 11.5. |

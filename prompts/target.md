...
| TARGET 11 | `prompts/TARGET_11_dsv4_sm80_mtp_speculative_decoding.md` | active MTP route | MTP weights/oracle, V1 sidecar, frozen-KV rollback, row0/`wo_a`, row/depth, `bs=4`, `bs=5`, path census, 11.8 contract, 11.9 explicit SGLang-shaped runtime, 11.10 attention/KV parity, 11.11 `wo_b` parity, and 11.12 downstream census narrowed the blocker to q/RoPE plus independent MoE/indexer owners; next is TARGET 11.13 operator parity framework with q_norm_rope pilot. |
